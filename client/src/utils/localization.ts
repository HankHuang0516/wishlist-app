...
const translations: Record<string, Record<string, string>> = {
    'zh-TW': {
        ...
        'settings.purchaseUnavailable': '購買與訂閱操作暫停；既有權益不受影響。若有持續扣款，請透過原付款平台管理。',
    ...
    'en-US': {
        ...
        'settings.purchaseUnavailable': 'Purchases and subscription changes are paused; existing benefits remain. Manage any ongoing charges through the original payment provider.',
