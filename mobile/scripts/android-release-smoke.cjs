...
(async () => {
  ...
  if (!/versionCode=16\b/.test(installed) || !/versionName=2\.0\.1\b/.test(installed)) throw new Error('Installed build identity/version did not match');
