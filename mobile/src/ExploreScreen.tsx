...
const s = StyleSheet.create({ screen: { flex: 1, backgroundColor: '#F8F7F3' }, flex: { flex: 1 }, search: { flexDirection: 'row', paddingHorizontal: 16, gap: 8 }, searchInput: { flex: 1, minHeight: 48, borderWidth: 1, borderColor: '#B4BDB4', borderRadius: 12, padding: 12, fontSize: 16, backgroundColor: '#FFFFFF' }, toolbar: { flexDirection: 'row', padding: 12, gap: 8, alignItems: 'center', flexWrap: 'wrap' },
  list: { padding: 16, gap: 16, paddingBottom: 32 }, wrap: { flexDirection: 'row', flexWrap: 'wrap', gap: 8 }, chip: { minHeight: 48, padding: 12, borderWidth: 1, borderColor: '#B4BDB4', borderRadius: 12, justifyContent: 'center' }, activeChip: { backgroundColor: '#DDEAE0', borderColor: '#173E36' }, text: { fontSize: 16, lineHeight: 24, color: '#173E36' }, small: { fontSize: 14, lineHeight: 22, color: '#596960' }, heading: { fontSize: 26, fontWeight: '800', color: '#173E36' }, price: { fontSize: 18, fontWeight: '700', color: '#173E36' }, input: { minHeight: 52, borderWidth: 1, borderColor: '#B4BDB4', borderRadius: 12, padding: 14, fontSize: 16, backgroundColor: '#FFFFFF', color: '#173E36' },
  card: { flexDirection: 'row', backgroundColor: '#FFFFFF', borderRadius: 16, padding: 12, gap: 12, marginBottom: 12 }, floatingCard: { position: 'absolute', bottom: 8, left: 12, right: 12 }, thumbnail: { width: 80, height: 80, borderRadius: 12 }, cardText: { flex: 1, gap: 4 }, cardTitle: { fontSize: 17, lineHeight: 24, fontWeight: '700', color: '#173E36' }, detailPhoto: { width: 240, height: 240, borderRadius: 12, marginRight: 12 }, button: { minHeight: 52, padding: 14, borderRadius: 14, backgroundColor: '#173E36', alignItems: 'center', justifyContent: 'center' }, white: { color: '#FFFFFF', fontSize: 16, fontWeight: '700' }, notice: { padding: 12, gap: 8 }, error: { color: '#A52626', fontSize: 14, lineHeight: 22 }, mapNotice: { position: 'absolute', top: 12, left: 12, right: 12, padding: 12, backgroundColor: '#FFFFFF', borderRadius: 12 },
});
