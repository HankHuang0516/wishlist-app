...
const s = StyleSheet.create({ screen: { flex: 1, backgroundColor: '#F8F7F3' }, flex: { flex: 1 }, header: { padding: 16, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }, content: { padding: 20, gap: 16, paddingBottom: 40 },
  title: { fontSize: 26, color: '#173E36', fontWeight: '800' }, text: { fontSize: 16, color: '#173E36', lineHeight: 24 }, small: { fontSize: 14, color: '#596960', lineHeight: 22 }, section: { fontSize: 18, color: '#173E36', fontWeight: '700' }, input: { minHeight: 52, borderWidth: 1, borderColor: '#B4BDB4', padding: 14, borderRadius: 12, fontSize: 16, color: '#173E36', backgroundColor: '#FFF' }, multiline: { minHeight: 110, textAlignVertical: 'top' },
  wrap: { flexDirection: 'row', flexWrap: 'wrap', gap: 10 }, chip: { minHeight: 48, padding: 12, borderWidth: 1, borderColor: '#B4BDB4', borderRadius: 12 }, selected: { backgroundColor: '#DDEAE0', borderColor: '#173E36' }, option: { minHeight: 48, padding: 12, justifyContent: 'center' }, button: { minHeight: 52, padding: 14, borderRadius: 14, backgroundColor: '#173E36', alignItems: 'center', justifyContent: 'center' }, white: { color: '#FFF', fontSize: 16, fontWeight: '700' }, error: { color: '#A52626', fontSize: 14, lineHeight: 22 }, photo: { width: 120 }, preview: { width: 120, height: 100, borderRadius: 10 },
});
