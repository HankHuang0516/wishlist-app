...
const s = StyleSheet.create({ screen: { flex: 1, backgroundColor: iosColors.background }, content: { padding: iosSpacing.lg, gap: iosSpacing.md, paddingBottom: 48 }, heading: { ...iosType.title, color: iosColors.label }, title: { ...iosType.headline, color: iosColors.label }, text: { ...iosType.body, color: iosColors.label }, small: { ...iosType.subheadline, color: iosColors.secondaryLabel }, error: { ...iosType.subheadline, color: iosColors.danger, backgroundColor: iosColors.dangerSoft, borderRadius: iosRadius.control, padding: iosSpacing.sm }, card: { padding: iosSpacing.md, gap: iosSpacing.sm, borderRadius: iosRadius.card, backgroundColor: iosColors.surface, ...iosShadow }, chip: { minHeight: minimumTapSize, paddingHorizontal: iosSpacing.md, paddingVertical: iosSpacing.sm, borderWidth: StyleSheet.hairlineWidth, borderColor: iosColors.separator, backgroundColor: iosColors.surface, borderRadius: iosRadius.pill, justifyContent: 'center' }, selected: { borderColor: iosColors.tint, backgroundColor: iosColors.tintSoft }, button: { minHeight: 52, padding: iosSpacing.md, borderRadius: iosRadius.control, backgroundColor: iosColors.tint, alignItems: 'center', justifyContent: 'center' }, white: { color: iosColors.white, ...iosType.headline }, input: { minHeight: 120, padding: iosSpacing.md, borderWidth: StyleSheet.hairlineWidth, borderColor: iosColors.separator, borderRadius: iosRadius.control, color: iosColors.label, backgroundColor: iosColors.surface, fontSize: 17, textAlignVertical: 'top' }, disabled: { opacity: 0.45 } });
