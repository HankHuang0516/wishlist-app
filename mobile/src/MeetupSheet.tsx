...
const s = StyleSheet.create({ screen: { flex: 1, backgroundColor: '#F8F7F3' }, content: { padding: 20, gap: 16 }, row: { flexDirection: 'row', alignItems: 'center', gap: 12, padding: 12 }, heading: { color: '#173E36', fontSize: 22, fontWeight: '800' }, text: { color: '#173E36', fontSize: 16, lineHeight: 25 }, small: { color: '#596960', fontSize: 14, lineHeight: 22 }, error: { color: '#A52626', fontSize: 14, lineHeight: 22 }, card: { backgroundColor: '#FFF', borderRadius: 16, padding: 16, gap: 12 }, chip: { minHeight: 48, borderWidth: 1, borderColor: '#B4BDB4', borderRadius: 12, padding: 12, justifyContent: 'center' }, button: { minHeight: 52, backgroundColor: '#173E36', borderRadius: 12, padding: 14, justifyContent: 'center' }, white: { color: '#FFF', fontSize: 16, fontWeight: '700' }, input: { minHeight: 52, padding: 12, borderWidth: 1, borderColor: '#B4BDB4', borderRadius: 12, color: '#173E36', fontSize: 16 } });
